  ...
  ComicController.prototype.getPopularComics = function (ctx) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, comic_model_1.default.find({}).sort({ popularity: -1 }).limit(10)]
          case 1:
            comics = _a.sent()
            ctx.response.status = status_1.ResponseCode.OK
            ctx.body = response_1.default.Success({ data: comics })
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              comicChapter_model_1.default
                .findOne({ comicId: id, chapter: chapter })
                .populate('comicId', 'name')
            ]
          case 1:
            comicImages = _b.sent()
            if (!comicImages) {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 2:
            ...
            return [
              4 /*yield*/,
              comic_model_1.default.find({ author: { $regex: author, $options: 'i' } })
            ]
          case 3:
          ...
          case 4:
            return [
              4 /*yield*/,
              comic_model_1.default.find({ name: { $regex: name, $options: 'i' } })
            ]
          case 5:
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              comicChapter_model_1.default.deleteOne({ comicId: comicId, chapter: chapter })
            ]
          case 1:
            ...
            return [
              4 /*yield*/,
              comic_model_1.default.updateOne({ _id: comicId }, { $inc: { chapters: -1 } })
            ]
          case 2:
            _b.sent()
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              comment_model_1.default.find({ comicId: comicId }).populate({
                path: 'userId',
                select: 'username'
              })
            ]
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              comment_model_1.default.create({ comicId: comicId, userId: userId, content: content })
            ]
          case 1:
            _a.sent()
            ctx.body = response_1.default.Success()
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              view_model_1.default.findOne({ userId: userId, comicId: comicId, date: date })
            ]
          case 1:
